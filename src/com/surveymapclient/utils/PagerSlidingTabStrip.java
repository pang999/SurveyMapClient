package com.surveymapclient.utils;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.parseColor("#eb433d");
	private int underlineColor = Color.parseColor("#ffffff");
	...
	private int selectedTabTextColor = Color.parseColor("#eb433d");
	private int tabTextSelectSize = 30;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		tabTextSelectSize = (int) TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_SP, tabTextSelectSize, dm);
		...
		tabTextSelectSize = a.getDimensionPixelSize(0, tabTextSelectSize);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft + 20, height - indicatorHeight,
