...
public class PolylineAdapter  extends BaseAdapter implements ListAdapter{

	private  LayoutInflater layoutInflater;
	
	private List<LineBean> list;
	
	public PolylineAdapter(Context context,List<LineBean> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			...
			convertView=layoutInflater.inflate(R.layout.listview_polyline, null);
