...
public class Line {
    ...
    public Line(Long id, Long key, String name, Float startx, Float starty, Float endx, Float endy, Double lenght, Double angle, String desc, Integer pcolor, Float pwidth, Boolean isfull) {
        this.id = id;
        this.key = key;
        this.name = name;
        this.startx = startx;
