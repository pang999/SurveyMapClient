...
public class GattAttributes {
	...
	static {
		...
		attributesUUID.put(UUIDDatabase.UUID_HEART_RATE_SERVICE,
				"Heart Rate Service");
		attributesUUID.put(UUIDDatabase.UUID_HEALTH_THERMOMETER_SERVICE,
				"Health Thermometer Service");
		attributesUUID.put(UUIDDatabase.UUID_GENERIC_ACCESS_SERVICE,
				"Generic Access Service");
		attributesUUID.put(UUIDDatabase.UUID_GENERIC_ATTRIBUTE_SERVICE,
				"Generic Attribute Service");
		attributesUUID.put(UUIDDatabase.UUID_DEVICE_INFORMATION_SERVICE,
				"Device Information Service");
		attributesUUID
				.put(UUIDDatabase.UUID_BATTERY_SERVICE, "Battery Service");
		attributesUUID.put(UUIDDatabase.UUID_IMMEDIATE_ALERT_SERVICE,
				"Immediate Alert");
		attributesUUID.put(UUIDDatabase.UUID_LINK_LOSS_SERVICE, "Link Loss");
		attributesUUID.put(UUIDDatabase.UUID_TRANSMISSION_POWER_SERVICE,
				"Tx Power");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_SERVICE,
				"CapSense Service");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_SERVICE_CUSTOM,
				"CapSense Service");
		attributesUUID
				.put(UUIDDatabase.UUID_RGB_LED_SERVICE, "RGB LED Service");
		attributesUUID.put(UUIDDatabase.UUID_RGB_LED_SERVICE_CUSTOM,
				"RGB LED Service");
		attributesUUID
				.put(UUIDDatabase.UUID_GLUCOSE_SERVICE, "Glucose Service");
		attributesUUID.put(UUIDDatabase.UUID_BLOOD_PRESSURE_SERVICE,
				"Blood Pressure Service");
		attributesUUID.put(UUIDDatabase.UUID_RSC_SERVICE,
				"Running Speed & Cadence Service");
		attributesUUID.put(UUIDDatabase.UUID_BAROMETER_SERVICE,
				"Barometer Service");
		attributesUUID.put(UUIDDatabase.UUID_ACCELEROMETER_SERVICE,
				"Accelerometer Service");
		attributesUUID.put(UUIDDatabase.UUID_ANALOG_TEMPERATURE_SERVICE,
				"Analog Temperature Service");
		attributesUUID.put(UUIDDatabase.UUID_CSC_SERVICE,
				"Cycling Speed & Cadence Service");
		attributesUUID.put(UUIDDatabase.UUID_ALERT_NOTIFICATION_SERVICE,
				"Alert notification Service");
		attributesUUID.put(UUIDDatabase.UUID_BODY_COMPOSITION_SERVICE,
				"Body Composition Service");
		attributesUUID.put(UUIDDatabase.UUID_BOND_MANAGEMENT_SERVICE,
				"Bond Management Service");
		attributesUUID.put(
				UUIDDatabase.UUID_CONTINUOUS_GLUCOSE_MONITORING_SERVICE,
				"Continuous Glucose Monitoring Service");
		attributesUUID.put(UUIDDatabase.UUID_CURRENT_TIME_SERVICE,
				"Current Time Service");
		attributesUUID.put(UUIDDatabase.UUID_CYCLING_POWER_SERVICE,
		...
		attributesUUID.put(UUIDDatabase.UUID_NEXT_DST_CHANGE_SERVICE,
				"Next DST Change Service");
		attributesUUID.put(UUIDDatabase.UUID_PHONE_ALERT_STATUS_SERVICE,
				"Phone Alert Status Service");
		attributesUUID.put(UUIDDatabase.UUID_REFERENCE_TIME_UPDATE_SERVICE,
				"Reference Time Update Service");
		attributesUUID.put(UUIDDatabase.UUID_SCAN_PARAMETERS_SERVICE,
				"Scan Paramenters Service");
		attributesUUID.put(UUIDDatabase.UUID_USER_DATA_SERVICE,
				"User Data Service");
		attributesUUID.put(UUIDDatabase.UUID_WEIGHT_SCALE_SERVICE,
				"Weight Scale Service");
		attributesUUID.put(UUIDDatabase.UUID_HEART_RATE_MEASUREMENT,
				"Heart Rate Measurement");
		attributesUUID.put(UUIDDatabase.UUID_BODY_SENSOR_LOCATION,
				"Body Sensor Location");
		attributesUUID.put(UUIDDatabase.UUID_HEART_RATE_CONTROL_POINT,
				"Heart Rate Control Point");
		attributesUUID.put(UUIDDatabase.UUID_HEALTH_THERMOMETER,
				"Health Thermometer Measurement");
		attributesUUID.put(
				UUIDDatabase.UUID_HEALTH_THERMOMETER_SENSOR_LOCATION,
				"Temperature Type");
		attributesUUID.put(UUIDDatabase.UUID_TEMPERATURE_INTERMEDIATE,
				"Intermediate Temperature");
		attributesUUID.put(UUIDDatabase.UUID_TEMPERATURE_MEASUREMENT_INTERVAL,
				"Measurement Interval");
		attributesUUID.put(UUIDDatabase.UUID_SYSTEM_ID, "System ID");
		attributesUUID.put(UUIDDatabase.UUID_MODEL_NUMBER_STRING,
				"Model Number String");
		attributesUUID.put(UUIDDatabase.UUID_SERIAL_NUMBER_STRING,
				"Serial Number String");
		attributesUUID.put(UUIDDatabase.UUID_FIRMWARE_REVISION_STRING,
				"Firmware Revision String");
		attributesUUID.put(UUIDDatabase.UUID_HARDWARE_REVISION_STRING,
				"Hardware Revision String");
		attributesUUID.put(UUIDDatabase.UUID_SOFTWARE_REVISION_STRING,
				"Software Revision String");
		attributesUUID.put(UUIDDatabase.UUID_MANUFACTURE_NAME_STRING,
		...
		attributesUUID.put(UUIDDatabase.UUID_TRANSMISSION_POWER_LEVEL,
				"Tx Power Level");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_BUTTONS,
				"CapSense Button");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_PROXIMITY,
				"CapSense Proximity");
		attributesUUID
				.put(UUIDDatabase.UUID_CAPSENSE_SLIDER, "CapSense Slider");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_BUTTONS_CUSTOM,
				"CapSense Button");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_PROXIMITY_CUSTOM,
				"CapSense Proximity");
		attributesUUID.put(UUIDDatabase.UUID_CAPSENSE_SLIDER_CUSTOM,
				"CapSense Slider");
		attributesUUID.put(UUIDDatabase.UUID_RGB_LED, "RGB LED");
		attributesUUID.put(UUIDDatabase.UUID_RGB_LED_CUSTOM, "RGB LED");
		attributesUUID.put(UUIDDatabase.UUID_GLUCOSE_MEASUREMENT,
				"Glucose Measurement");
		attributesUUID.put(UUIDDatabase.UUID_GLUCOSE_MEASUREMENT_CONTEXT,
				"Glucose Measurement Context");
		attributesUUID
				.put(UUIDDatabase.UUID_GLUCOSE_FEATURE, "Glucose Feature");
		...
		attributesUUID.put(UUIDDatabase.UUID_BLOOD_PRESSURE_FEATURE,
				"Blood Pressure Feature");
		attributesUUID.put(UUIDDatabase.UUID_BLOOD_PRESSURE_MEASUREMENT,
				"Blood Pressure Measurement");
		attributesUUID.put(UUIDDatabase.UUID_RSC_MEASURE,
				"Running Speed and Cadence Measurement");
		attributesUUID.put(UUIDDatabase.UUID_RSC_FEATURE,
				"Running Speed and Cadence Feature");
		attributesUUID.put(UUIDDatabase.UUID_SC_CONTROL_POINT,
				"Speed and Cadence Control Point");
		attributesUUID.put(UUIDDatabase.UUID_SC_SENSOR_LOCATION,
				"Speed and Cadence Sensor Location");
		attributesUUID.put(UUIDDatabase.UUID_CSC_MEASURE,
				"Cycling Speed and Cadence Measurement");
		attributesUUID.put(UUIDDatabase.UUID_CSC_FEATURE,
		...
		attributesUUID.put(UUIDDatabase.UUID_ACCELEROMETER_READING_X,
				"Accelerometer X Reading");
		attributesUUID.put(UUIDDatabase.UUID_ACCELEROMETER_READING_Y,
				"Accelerometer Y Reading");
		attributesUUID.put(UUIDDatabase.UUID_ACCELEROMETER_READING_Z,
				"Accelerometer Z Reading");
		attributesUUID.put(
				UUIDDatabase.UUID_ACCELEROMETER_SENSOR_SCAN_INTERVAL,
		...
		attributesUUID.put(UUIDDatabase.UUID_BAROMETER_DIGITAL_SENSOR,
				"Barometer Digital Sensor");
		attributesUUID.put(UUIDDatabase.UUID_BAROMETER_READING,
				"Barometer Reading");
		attributesUUID.put(UUIDDatabase.UUID_BAROMETER_SENSOR_SCAN_INTERVAL,
				"Barometer Sensor Scan Interval");
		attributesUUID.put(
				UUIDDatabase.UUID_BAROMETER_THRESHOLD_FOR_INDICATION,
				"Barometer Threshold for Indication");
		attributesUUID.put(UUIDDatabase.UUID_TEMPERATURE_ANALOG_SENSOR,
				"Temperature Analog Sensor");
		attributesUUID.put(UUIDDatabase.UUID_TEMPERATURE_READING,
				"Temperature Reading");
		...
		attributesUUID.put(UUIDDatabase.UUID_BOOT_KEYBOARD_INPUT_REPORT,
				"Boot Keyboard Input Report");
		attributesUUID.put(UUIDDatabase.UUID_BOOT_KEYBOARD_OUTPUT_REPORT,
				"Boot Keyboard Output Report");
		attributesUUID.put(UUIDDatabase.UUID_BOOT_MOUSE_INPUT_REPORT,
				"Boot Mouse Input Report");
		attributesUUID.put(UUIDDatabase.UUID_HID_CONTROL_POINT,
				"HID Control Point");
		attributesUUID
				.put(UUIDDatabase.UUID_HID_INFORMATION, "HID Information");
		attributesUUID.put(UUIDDatabase.UUID_OTA_UPDATE_SERVICE,
				"Bootloader Service");
		attributesUUID.put(UUIDDatabase.UUID_OTA_CHARACTERISTIC,
				"Bootloader Data Characteristic");
		...
		attributesUUID.put(UUIDDatabase.UUID_ALERT_CATEGORY_ID,
				"Alert Category Id");
		attributesUUID.put(UUIDDatabase.UUID_ALERT_CATEGORY_ID_BIT_MASK,
				"Alert Category_id_Bit_Mask");
		...
		attributesUUID.put(UUIDDatabase.UUID_ANAEROBIC_THRESHOLD,
				"Anaerobic Threshold");
		attributesUUID.put(UUIDDatabase.UUID_APPARENT_WIND_DIRECTION,
				"Apparent Wind Direction");
		attributesUUID.put(UUIDDatabase.UUID_APPARENT_WIND_SPEED,
				"Apparent Wind Speed");
		attributesUUID.put(UUIDDatabase.UUID_APPEARANCE, "Appearance");
		attributesUUID.put(UUIDDatabase.UUID_BAROMETRIC_PRESSURE_TREND,
				"Barometric pressure Trend");
		attributesUUID.put(UUIDDatabase.UUID_BLOOD_PRESSURE_MEASUREMENT,
				"Blood Pressure Measurement");
		attributesUUID.put(UUIDDatabase.UUID_BODY_COMPOSITION_FEATURE,
				"Body Composition Feature");
		attributesUUID.put(UUIDDatabase.UUID_BODY_COMPOSITION_MEASUREMENT,
				"Body Composition Measurement");
		attributesUUID.put(UUIDDatabase.UUID_BOND_MANAGEMENT_CONTROL_POINT,
				"Bond Management Control Point");
		attributesUUID.put(UUIDDatabase.UUID_BOND_MANAGEMENT_FEATURE,
				"Bond Management feature");
		attributesUUID.put(UUIDDatabase.UUID_CGM_FEATURE, "CGM Feature");
		attributesUUID.put(UUIDDatabase.UUID_CENTRAL_ADDRESS_RESOLUTION,
		...
		attributesUUID
				.put(UUIDDatabase.UUID_CGM_MEASUREMENT, "CGM Measurement");
		attributesUUID.put(UUIDDatabase.UUID_CGM_SESSION_RUN_TIME,
				"CGM Session Run Time");
		attributesUUID.put(UUIDDatabase.UUID_CGM_SESSION_START_TIME,
				"CGM Session Start Time");
		attributesUUID.put(UUIDDatabase.UUID_CGM_SPECIFIC_OPS_CONTROL_POINT,
				"CGM Specific Ops Control Point");
		attributesUUID.put(UUIDDatabase.UUID_CGM_STATUS, "CGM Status");
		attributesUUID.put(UUIDDatabase.UUID_CYCLING_POWER_CONTROL_POINT,
				"Cycling Power Control Point");
		attributesUUID.put(UUIDDatabase.UUID_CYCLING_POWER_VECTOR,
				"Cycling Power Vector");
		attributesUUID.put(UUIDDatabase.UUID_CYCLING_POWER_FEATURE,
				"Cycling Power Feature");
		attributesUUID.put(UUIDDatabase.UUID_CYCLING_POWER_MEASUREMENT,
				"Cycling Power Measurement");
		attributesUUID.put(UUIDDatabase.UUID_DATABASE_CHANGE_INCREMENT,
				"Database Change Increment");
		attributesUUID.put(UUIDDatabase.UUID_DATE_OF_BIRTH, "Date Of Birth");
		attributesUUID.put(UUIDDatabase.UUID_DATE_OF_THRESHOLD_ASSESSMENT,
		...
		attributesUUID.put(UUIDDatabase.UUID_DESCRIPTOR_VALUE_CHANGED,
		...
		attributesUUID.put(UUIDDatabase.UUID_FAT_BURN_HEART_RATE_LOWER_LIMIT,
				"Fat Burn Heart Rate lower Limit");
		attributesUUID.put(UUIDDatabase.UUID_FAT_BURN_HEART_RATE_UPPER_LIMIT,
				"Fat Burn Heart Rate Upper Limit");
		attributesUUID.put(UUIDDatabase.UUID_FIRMWARE_REVISION_STRING,
				"Firmware Revision String");
		attributesUUID.put(UUIDDatabase.UUID_FIVE_ZONE_HEART_RATE_LIMITS,
		...
		attributesUUID.put(UUIDDatabase.UUID_HIP_CIRCUMFERENCE,
				"Hip Circumference");
		attributesUUID.put(UUIDDatabase.UUID_HUMIDITY, "Humidity");
		attributesUUID.put(UUIDDatabase.UUID_INTERMEDIATE_CUFF_PRESSURE,
				"Intermediate Cuff Pressure");
		attributesUUID.put(UUIDDatabase.UUID_INTERMEDIATE_TEMPERATURE,
				"Intermediate Temperature");
		...
		attributesUUID.put(UUIDDatabase.UUID_LN_CONTROL_POINT,
				"LN Control Point");
		attributesUUID.put(UUIDDatabase.UUID_LN_FEATURE, "LN Feature");
		attributesUUID.put(UUIDDatabase.UUID_LOCAL_TIME_INFORMATION,
				"Local Time Information");
		attributesUUID.put(UUIDDatabase.UUID_LOCATION_AND_SPEED,
				"Location and Speed");
		attributesUUID.put(UUIDDatabase.UUID_MAGNETIC_DECLINATION,
				"Magenetic Declination");
		attributesUUID.put(UUIDDatabase.UUID_MAGNETIC_FLUX_DENSITY_2D,
				"Magentic Flux Density 2D");
		attributesUUID.put(UUIDDatabase.UUID_MAGNETIC_FLUX_DENSITY_3D,
				"Magentic Flux Density 3D");
		attributesUUID.put(UUIDDatabase.UUID_MAXIMUM_RECOMMENDED_HEART_RATE,
				"Maximum Recommended Heart Rate");
		attributesUUID.put(UUIDDatabase.UUID_MEASUREMENT_INTERVAL,
				"Measurement Interval");
		attributesUUID.put(UUIDDatabase.UUID_MODEL_NUMBER_STRING,
				"Model Number String");
		...
		attributesUUID.put(
				UUIDDatabase.UUID_PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS,
				"Peripheral Preferred Connection Parameters");
		attributesUUID.put(UUIDDatabase.UUID_PERIPHERAL_PRIVACY_FLAG,
				"Peripheral Privacy Flag");
		attributesUUID.put(UUIDDatabase.UUID_POLLEN_CONCENTRATION,
				"Pollen Concentration");
		attributesUUID.put(UUIDDatabase.UUID_POSITION_QUALITY,
				"Position Quality");
		attributesUUID.put(UUIDDatabase.UUID_PRESSURE, "Pressure");
		attributesUUID.put(
				UUIDDatabase.UUID_CHARACTERISTIC_EXTENDED_PROPERTIES,
				"Characteristic Extended Properties");
		attributesUUID.put(UUIDDatabase.UUID_CHARACTERISTIC_USER_DESCRIPTION,
				"Characteristic User Description");
		attributesUUID.put(UUIDDatabase.UUID_CLIENT_CHARACTERISTIC_CONFIG,
				"Client Characteristic Configuration");
		attributesUUID.put(
				UUIDDatabase.UUID_SERVER_CHARACTERISTIC_CONFIGURATION,
				"Server Characteristic Configuration");
		attributesUUID.put(
				UUIDDatabase.UUID_CHARACTERISTIC_PRESENTATION_FORMAT,
				"Characteristic Presentation Format");
		attributesUUID.put(UUIDDatabase.UUID_CHARACTERISTIC_AGGREGATE_FORMAT,
				"Characteristic Aggregate Format");
		attributesUUID.put(UUIDDatabase.UUID_VALID_RANGE, "Valid Range");
		attributesUUID.put(UUIDDatabase.UUID_EXTERNAL_REPORT_REFERENCE,
				"External Report Reference");
		attributesUUID.put(UUIDDatabase.UUID_REPORT_REFERENCE,
				"Report Reference");
		attributesUUID.put(
				UUIDDatabase.UUID_ENVIRONMENTAL_SENSING_CONFIGURATION,
				"Environmental Sensing Configuration");
		attributesUUID.put(UUIDDatabase.UUID_ENVIRONMENTAL_SENSING_MEASUREMENT,
				"Environmental Sensing Measurement");
		attributesUUID.put(
				UUIDDatabase.UUID_ENVIRONMENTAL_SENSING_TRIGGER_SETTING,
				"Environmental Sensing Trigger Setting");
		rdkAttributesUUID.put(Integer.valueOf(0), "Report Mouse");
		rdkAttributesUUID.put(Integer.valueOf(1), "Report Keyboard");
		rdkAttributesUUID.put(Integer.valueOf(Constants.ZOOM_AXIS_Y),
				"Report Multimedia");
		// rdkAttributesUUID.put(Integer.valueOf(WearableExtender.SIZE_MEDIUM),
		// "Report Power");
		rdkAttributesUUID.put(
				Integer.valueOf(TransportMediator.FLAG_KEY_MEDIA_PLAY),
				"Report Audio Control");
		// rdkAttributesUUID.put(Integer.valueOf(WearableExtender.SIZE_FULL_SCREEN),
		// "Report Audio Data");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_SERVICE,
				"CapSense Services");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_SERVICE_CUSTOM,
				"CapSense Services");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_BUTTONS,
				"CapSense Button");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_BUTTONS_CUSTOM,
				"CapSense Button");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_PROXIMITY,
				"CapSense Proximity");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_PROXIMITY_CUSTOM,
				"CapSense Proximity");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_SLIDER,
				"CapSense Slider");
		attributesCapSense.put(UUIDDatabase.UUID_CAPSENSE_SLIDER_CUSTOM,
				"CapSense Slider");
	...
	public static String lookupReferenceRDK(int instanceid, String defaultName) {
		String name = rdkAttributesUUID.get(Integer.valueOf(instanceid));
		return name == null ? defaultName : name;
	}
